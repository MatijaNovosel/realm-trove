<template>
  <div class="contents">
    ...
    <div class="offset px-3">
      ...
      <div class="flex justify-center mt-6" v-if="user">
        <text-button
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to Realm trove.
        </li>
        <li>
        ...
        <li>
          Website refers to Realm trove, accessible from
          https://www.realm-trove.com
        </li>
        <li>
          You means the individual accessing or using the Service, or the
          company, or other legal entity on behalf of which such individual is
          accessing or using the Service, as applicabl
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          o manage Your requests: To attend and manage Your requests to Us.
        </li>
        <li>
