...
import { BP_QUALITY, SOURCE } from "~/utils/constants";
...
export const ITEMS_BP: ItemInfo[] = [
  ...
  {
    id: 3014,
    name: "Sealed Crystal Skull, Snake Charmer Pungi, Spectral Cloth Armor",
    bp: {
      quality: BP_QUALITY.SUPERIOR,
      items: [
        {
  ...
  {
    id: 3138,
    name: "Yellow Beehemoth Armor, Red Beehemoth Armor, Blue Beehemoth Armor",
    bp: {
      quality: BP_QUALITY.SUPERIOR,
      items: [
        {
  ...
  },
  {
    ...
    source: SOURCE.GODLANDS_DUNGEONS
  },
  {
    id: 3082,
    name: "Snakeskin Shield, Poison Fang Dagger, Honey Scepter, Orb of Sweet Demise",
    bp: {
      quality: BP_QUALITY.BASIC,
      items: [
        {
